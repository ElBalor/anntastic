...
const ProductPage = ({ name, desc, images, price }: Props) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-10 z-[20] px-2">
      <div className="product-card">
        <div
          className={`card ${isFlipped || spinning ? "flipped" : ""} ${
            spinning ? "flipped" : ""
          }`}
        >
          <div className="card-face card-front flex flex-col items-center mt-8 md:mt-0">
            <Image
          ...
          <div className="card-face card-back ml-14 mt-16 md:mt-0 md:ml-0">
            <Image
